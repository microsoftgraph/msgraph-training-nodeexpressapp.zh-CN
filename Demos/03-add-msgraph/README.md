# <a name="how-to-run-the-completed-project"></a><span data-ttu-id="85d58-101">如何运行已完成的项目</span><span class="sxs-lookup"><span data-stu-id="85d58-101">How to run the completed project</span></span>
